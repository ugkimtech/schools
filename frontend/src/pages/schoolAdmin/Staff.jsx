...
export default function Staff(){
    ...
    // matching groups data with form fields
    const permissions = groups.map((group, index)=>(
        ...
        <>
            ...
            <Form form={{
                title: 'Add New Staff Member', fields:[
                    ...
                    {field:'dropdown', label:'Access Permissions', name:'groups', options:permissions},
                    ...
                    {field:'dropdown', label:'Department', name:'departments', options:departmentsData},
                    ...
                    {field:'dropdown', label:'Subjects Taught (If Teacher)', name:'subjects_taught', options:subjectsData},
                    {field:'dropdown', label:'Classes Taught (If Teacher)', name:'classes_taught', options:classesData},
